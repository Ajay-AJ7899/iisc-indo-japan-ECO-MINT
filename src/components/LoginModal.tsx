              ...
              <div className="bg-white/5 rounded-lg p-6 border border-white/10">
                ...
                <div className="mb-6 bg-white/10 rounded-lg p-4 border border-white/20">
                  <div className="flex items-center mb-3">
                    ...
                    <p className="text-white/90 text-sm font-semibold">Quick Demo Login</p>
                  </div>
                  <p className="text-white/60 text-xs mb-3">Click to auto-fill credentials for testing:</p>
                  
                  {portalType === 'ngo' && (
                    <Button
                      onClick={() => setCredentials({ username: 'ngo', password: 'ngo123' })}
                      disabled={isLoggingIn}
                      className="w-full bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-300 border border-emerald-400/30 h-auto py-2.5 px-4"
                    >
                      <User className="w-4 h-4 mr-2" />
                      Login as NGO Demo User
                    </Button>
                  )}
                  ...
                  {portalType === 'admin' && (
                    <Button
                      ...
                      disabled={isLoggingIn}
                      className="w-full bg-blue-500/20 hover:bg-blue-500/30 text-blue-300 border border-blue-400/30 h-auto py-2.5 px-4"
                    >
                  ...
                  {portalType === 'investor' && (
                    <Button
                      onClick={() => setCredentials({ username: 'investor', password: 'investor123' })}
                      disabled={isLoggingIn}
                      className="w-full bg-purple-500/20 hover:bg-purple-500/30 text-purple-300 border border-purple-400/30 h-auto py-2.5 px-4"
                    >
                      <Wallet className="w-4 h-4 mr-2" />
                      Login as Buyer Demo User
                    </Button>
                  )}
                </div>
